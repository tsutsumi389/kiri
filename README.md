...
かかる時間は画像の面積ではなく**帯の面積（周長 × 帯幅）**で決まる。12MP での追加
コストは、角丸矩形ならほぼ 0ms、メッシュのように構造が帯より細い素材（櫛状 12px
周期）で +259ms、同 6px 周期で +655ms。
...
- `edge_width` は 1〜3 が正常、6 以上なら輪郭がぼやけている
...
**1〜3 が正常**で、refine 済みの鮮鋭な輪郭はちょうど 1.00 になる。柔らかい輪郭では
素材の遷移幅に追従して 6 前後まで伸び、そこまで来ると輪郭がぼやけている。
